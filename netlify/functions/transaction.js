...
const serviceAccount = {
    ...
    // *** ANGYARA NAN DON AMFANI DA BASE64 ENCODED PRIVATE KEY ***
    // Wannan layin zai karbi BASE64_ENCODED_PRIVATE_KEY din daga Netlify
    // sannan ya maida shi zuwa asalin tsarin private key din
    "private_key": Buffer.from(process.env.FIREBASE_PRIVATE_KEY_BASE64, 'base64').toString('ascii').replace(/\\n/g, '\n'),
    "client_email": process.env.FIREBASE_CLIENT_EMAIL, // Na gyara wannan layin domin ya cika
